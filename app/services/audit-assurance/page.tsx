    ...
    <main ref={containerRef} className="bg-[#F8FAFC] text-[#0B132B] min-h-screen overflow-hidden">
      ...
      <div className="pt-24 pb-4 px-6 md:px-12 max-w-7xl mx-auto">
        <nav className="flex items-center text-sm font-medium text-gray-500">
          <Link href="/" className="hover:text-[#10B981] transition-colors duration-200">Home</Link>
          <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
          <Link href="/services" className="hover:text-[#10B981] transition-colors duration-200">Services</Link>
          <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <div className="hero-actions flex flex-wrap gap-4">
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center px-6 py-3.5 rounded-lg bg-[#0B132B] text-white font-medium hover:bg-[#1a295c] hover:scale-105 transition-all duration-300 group shadow-lg shadow-blue-900/20 hover:shadow-xl hover:shadow-blue-900/30"
              >
              ...
              <Link 
                href="#overview" 
                className="inline-flex items-center justify-center px-6 py-3.5 rounded-lg bg-white text-[#0B132B] font-medium border border-gray-200 hover:border-gray-300 hover:bg-gray-50 hover:scale-105 transition-all duration-300"
              >
                Explore Services
              </Link>
            </div>
      ...
      <section id="overview" className="overview-section py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="bento-grid grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(250px,auto)]">
            ...
            <div className="bento-item md:col-span-2 bg-[#F8FAFC] rounded-2xl p-8 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-lg hover:border-gray-200 transition-all duration-300">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#2563EB]/5 to-transparent rounded-bl-full -z-10 group-hover:from-[#2563EB]/10 transition-colors duration-300"></div>
              <div className="w-12 h-12 rounded-xl bg-[#2563EB]/10 flex items-center justify-center text-[#2563EB] mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            {/* Feature 2 */}
            <div className="bento-item bg-[#0B132B] rounded-2xl p-8 border border-[#0B132B] shadow-sm text-white relative overflow-hidden group hover:shadow-xl hover:scale-105 transition-all duration-300">
              <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-tl from-[#10B981]/20 to-transparent rounded-tl-full -z-0 group-hover:from-[#10B981]/30 transition-colors duration-300"></div>
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center text-[#10B981] mb-6 group-hover:bg-white/20 transition-colors duration-300">
            ...
            {/* Feature 3 */}
            <div className="bento-item bg-white rounded-2xl p-8 border border-gray-200 shadow-sm hover:border-[#10B981]/30 hover:shadow-md transition-all duration-300 group">
              <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center text-[#0B132B] mb-6 group-hover:bg-[#10B981]/10 group-hover:text-[#10B981] group-hover:scale-110 transition-all duration-300">
            ...
            <div className="bento-item md:col-span-2 bg-[#F8FAFC] rounded-2xl p-8 border border-gray-100 shadow-sm flex flex-col justify-center relative overflow-hidden hover:shadow-lg hover:border-gray-200 transition-all duration-300 group">
              <div className="absolute right-0 bottom-0 opacity-5 pointer-events-none group-hover:opacity-10 transition-opacity duration-300">
                <Shield className="w-64 h-64 translate-x-1/4 translate-y-1/4" />
              </div>
              <div className="w-12 h-12 rounded-xl bg-[#10B981]/10 flex items-center justify-center text-[#10B981] mb-6 group-hover:scale-110 transition-transform duration-300">
      ...
      {/* Benefits Section */}
      <section className="benefits-section py-24 bg-[#F8FAFC] relative overflow-hidden">
        
        {/* Animated Background */}
        <div className="absolute inset-0 pointer-events-none opacity-30">
          <Player
            component={() => import('../../remotion/FloatingParticles').then(m => ({ default: m.FloatingParticles }))}
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-[#2563EB]/5 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-tl from-[#10B981]/5 to-transparent rounded-full blur-3xl"></div>

        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          
          <div className="benefits-header text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center justify-center p-2 bg-[#10B981]/10 rounded-xl mb-6">
              <Shield className="w-6 h-6 text-[#10B981]" />
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B132B] mb-4">Why Choose Our Assurance Services?</h2>
            <p className="text-lg text-gray-600">
              We deliver more than just a compliance certificate. Our audit process is designed to add tangible value to your organization.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Unbiased, objective insights into your financial health, providing management with a clear, unvarnished view of operational realities.",
                color: "#2563EB"
              },
              {
                icon: Shield,
                title: "Stakeholder Confidence",
                desc: "Build unwavering trust with banks, investors, and partners through financial reporting that bears the hallmark of rigorous professional scrutiny.",
                color: "#10B981"
              },
              {
                icon: Zap,
                title: "Operational Insights",
                desc: "Our deep-dive approach often uncovers inefficiencies, allowing us to recommend process improvements that enhance your bottom line.",
                color: "#F59E0B"
              },
              {
                icon: Award,
                title: "Regulatory Excellence",
                desc: "Stay ahead of changing legislation. We ensure your reporting meets all current IFRS, SA GAAP, and Companies Act requirements.",
                color: "#8B5CF6"
              },
              {
                icon: Search,
                title: "Fraud Deterrence",
                desc: "Robust internal audit reviews and control testing significantly reduce the risk of financial irregularities and occupational fraud.",
                color: "#EF4444"
              },
              {
                icon: Briefcase,
                title: "Strategic Alignment",
                desc: "We ensure your financial governance aligns with your long-term strategic goals and the ethical leadership principles of King IV.",
                color: "#06B6D4"
              }
            ].map((benefit, index) => (
              <div 
                key={index} 
                className="benefit-card bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-white/50 shadow-sm hover:shadow-xl hover:bg-white/90 hover:scale-105 transition-all duration-300 group cursor-pointer"
              >
                <div 
                  className="w-14 h-14 rounded-full bg-gray-50 flex items-center justify-center text-[#0B132B] mb-6 group-hover:scale-110 transition-all duration-300"
                  style={{ 
                ...
                <h4 className="text-xl font-bold text-[#0B132B] mb-3 group-hover:text-[#2563EB] transition-colors duration-300">{benefit.title}</h4>
      ...
      <section className="cta-section py-24 relative overflow-hidden bg-[#0B132B]">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10 text-center cta-content">
          <div className="inline-flex items-center justify-center p-3 bg-white/10 rounded-2xl mb-8 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-colors duration-300">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/contact" 
              className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 rounded-lg bg-[#10B981] text-white font-semibold text-lg hover:bg-[#0d9668] hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)]"
            >
              Request an Audit Consultation
            </Link>
            <Link 
              href="/contact" 
              className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 rounded-lg bg-transparent text-white font-semibold text-lg border border-white/30 hover:bg-white/10 hover:border-white/50 hover:scale-105 transition-all duration-300"
            >
