  ...
  return (
    <main ref={containerRef} className="bg-[#F8FAFC] min-h-screen font-sans selection:bg-[#10B981] selection:text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <div className="gsap-hero-btn flex flex-wrap gap-4">
                <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 text-sm font-semibold text-[#0B132B] bg-white rounded-full hover:bg-gray-100 transition-colors shadow-lg shadow-white/10 group">
                  Consult a Tax Expert
                  <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link href="#overview" className="inline-flex items-center justify-center px-8 py-4 text-sm font-semibold text-white border border-white/20 rounded-full hover:bg-white/5 transition-colors">
                  Explore Services
                </Link>
              </div>
            </div>
            ...
            <div className="gsap-hero-visual hidden lg:flex justify-center items-center relative h-[500px]">
              ...
              <div className="gsap-shape absolute right-0 top-10 w-72 h-80 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-6 flex flex-col justify-between transform rotate-6">
              ...
              <div className="gsap-shape absolute left-10 bottom-10 w-80 h-96 bg-[#10B981]/10 backdrop-blur-2xl border border-[#10B981]/20 rounded-3xl shadow-2xl p-8 flex flex-col z-10 transform -rotate-3">
          ...
          <div className="gsap-overview-trigger grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="gsap-slide-left lg:col-span-5 hidden lg:block relative">
              <div className="aspect-square rounded-full bg-[#F8FAFC] flex items-center justify-center relative border border-gray-100 shadow-sm">
                ...
                {/* Floating badge */}
                <div className="absolute -right-8 top-1/4 bg-white p-4 rounded-xl shadow-lg border border-gray-100 flex items-center space-x-3">
      ...
      <section className="py-24 lg:py-32 bg-[#F8FAFC]">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="gsap-benefits-trigger grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Benefit 1 */}
            <div className="gsap-benefit-card bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Large Bento Item */}
            <div className="gsap-benefit-card md:col-span-2 lg:col-span-3 bg-[#0B132B] rounded-2xl p-8 lg:p-12 relative overflow-hidden text-white flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="md:w-1/3 relative z-10 flex justify-start md:justify-end w-full">
                <Link href="/contact" className="inline-flex items-center justify-center px-6 py-3 text-sm font-semibold text-[#0B132B] bg-white rounded-full hover:bg-gray-100 transition-colors w-full md:w-auto text-center">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <div className="gsap-cta-block bg-[#0B132B] rounded-3xl p-10 lg:p-16 text-center relative overflow-hidden shadow-2xl">
            {/* Background design elements */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none rounded-3xl">
              <div className="absolute -top-24 -left-24 w-64 h-64 bg-[#2563EB] rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
              <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-[#10B981] rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
            </div>
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/contact" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white bg-[#10B981] rounded-full hover:bg-[#059669] transition-colors shadow-lg shadow-[#10B981]/25 group">
                  Consult a Tax Expert
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link href="/contact" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white border border-white/20 rounded-full hover:bg-white/10 transition-colors">
                  Send a Message
                </Link>
              </div>
            </div>
