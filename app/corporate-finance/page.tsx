...
export default function CorporateFinancePage() {
  ...
  useGSAP(() => {
    ...
    // 4. Track Record Section Animation
    gsap.from('.track-record-header', {
      scrollTrigger: {
        trigger: '.track-record-section',
        start: 'top 80%',
      },
      y: 40,
      opacity: 0,
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#F8FAFC] text-[#0B132B] overflow-hidden">
      ...
      {/* 3. Process & Approach Section */}
      <section className="process-section py-24 px-6 md:px-12 lg:px-24 bg-gradient-to-br from-[#F8FAFC] to-white relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#2563EB]/5 rounded-full filter blur-[100px] pointer-events-none"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#10B981]/5 rounded-full filter blur-[80px] pointer-events-none"></div>
        
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="process-header text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B132B] mb-6 font-heading">
              Our Proven Process & Approach
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed">
              Every engagement follows our structured methodology, ensuring thorough analysis, strategic insight, and flawless execution from initial consultation to successful transaction closure.
            </p>
          </div>
          ...
          <div className="process-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="process-step group relative">
              <div className="bg-white p-8 rounded-2xl shadow-lg shadow-gray-900/5 border border-gray-100 hover:shadow-xl hover:shadow-blue-900/10 transition-all duration-300 group-hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#2563EB] to-[#1d4ed8] text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <FileText className="w-8 h-8" />
                </div>
                <div className="text-sm font-bold text-[#2563EB] mb-2">STEP 1</div>
                <h3 className="text-xl font-bold text-[#0B132B] mb-4 font-heading">Strategic Analysis</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Comprehensive assessment of your business model, financial position, market dynamics, and strategic objectives to define the optimal transaction structure.
                </p>
              </div>
              {/* Connector Line */}
              <div className="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-[#2563EB] to-[#10B981] transform -translate-y-1/2"></div>
            </div>

            {/* Step 2 */}
            <div className="process-step group relative">
              <div className="bg-white p-8 rounded-2xl shadow-lg shadow-gray-900/5 border border-gray-100 hover:shadow-xl hover:shadow-blue-900/10 transition-all duration-300 group-hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#10B981] to-[#059669] text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <TrendingUp className="w-8 h-8" />
                </div>
                <div className="text-sm font-bold text-[#10B981] mb-2">STEP 2</div>
                <h3 className="text-xl font-bold text-[#0B132B] mb-4 font-heading">Market Positioning</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Development of compelling investment memoranda, financial models, and presentation materials that effectively communicate your value proposition to target audiences.
                </p>
              </div>
              {/* Connector Line */}
              <div className="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-[#10B981] to-[#f59e0b] transform -translate-y-1/2"></div>
            </div>

            {/* Step 3 */}
            <div className="process-step group relative">
              <div className="bg-white p-8 rounded-2xl shadow-lg shadow-gray-900/5 border border-gray-100 hover:shadow-xl hover:shadow-blue-900/10 transition-all duration-300 group-hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#f59e0b] to-[#d97706] text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Users className="w-8 h-8" />
                </div>
                <div className="text-sm font-bold text-[#f59e0b] mb-2">STEP 3</div>
                <h3 className="text-xl font-bold text-[#0B132B] mb-4 font-heading">Stakeholder Engagement</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Systematic approach to identifying, qualifying, and engaging with potential buyers, investors, or strategic partners through our extensive network and market intelligence.
                </p>
              </div>
              {/* Connector Line */}
              <div className="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-[#f59e0b] to-[#8b5cf6] transform -translate-y-1/2"></div>
            </div>

            {/* Step 4 */}
            <div className="process-step group">
              <div className="bg-white p-8 rounded-2xl shadow-lg shadow-gray-900/5 border border-gray-100 hover:shadow-xl hover:shadow-blue-900/10 transition-all duration-300 group-hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#8b5cf6] to-[#7c3aed] text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Handshake className="w-8 h-8" />
                </div>
                <div className="text-sm font-bold text-[#8b5cf6] mb-2">STEP 4</div>
                <h3 className="text-xl font-bold text-[#0B132B] mb-4 font-heading">Transaction Execution</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Expert negotiation, due diligence coordination, and deal structuring to maximize value while ensuring regulatory compliance and seamless transaction closure.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-4 px-6 py-3 bg-white rounded-full shadow-lg border border-gray-100">
              ...
              <span className="text-sm font-medium text-gray-700">Typical engagement duration: 3-9 months depending on complexity</span>
            </div>
          </div>
        </div>
      </section>

      {/* 4. Track Record & Case Studies Section */}
      <section className="track-record-section py-24 px-6 md:px-12 lg:px-24 bg-white relative">
        <div className="max-w-7xl mx-auto">
          <div className="track-record-header text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B132B] mb-6 font-heading">
              Proven Track Record of Success
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed">
              Our expertise spans multiple sectors and transaction types, consistently delivering superior outcomes for clients across Sub-Saharan Africa's dynamic markets.
            </p>
          </div>

          {/* Key Statistics */}
          <div className="stats-grid grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
            <div className="stat-card text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl border border-blue-200/50">
              <div className="text-3xl md:text-4xl font-bold text-[#2563EB] mb-2">R8.2B+</div>
              <div className="text-sm font-medium text-gray-600">Total Transaction Value</div>
            </div>
            <div className="stat-card text-center p-6 bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-2xl border border-emerald-200/50">
              <div className="text-3xl md:text-4xl font-bold text-[#10B981] mb-2">47</div>
              <div className="text-sm font-medium text-gray-600">Completed Transactions</div>
            </div>
            <div className="stat-card text-center p-6 bg-gradient-to-br from-amber-50 to-amber-100/50 rounded-2xl border border-amber-200/50">
              <div className="text-3xl md:text-4xl font-bold text-[#f59e0b] mb-2">94%</div>
              <div className="text-sm font-medium text-gray-600">Success Rate</div>
            </div>
            <div className="stat-card text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-2xl border border-purple-200/50">
              <div className="text-3xl md:text-4xl font-bold text-[#8b5cf6] mb-2">12</div>
              <div className="text-sm font-medium text-gray-600">African Countries</div>
            </div>
          </div>
          ...
          <div className="case-studies-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Case Study 1 */}
            <div className="case-study-card group bg-gradient-to-br from-[#0B132B] to-[#1e3a5f] p-8 rounded-2xl text-white relative overflow-hidden hover:scale-105 transition-transform duration-300">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#2563EB]/20 rounded-full filter blur-[40px] pointer-events-none"></div>
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-[#2563EB]/20 border border-[#2563EB]/30 flex items-center justify-center mb-6">
                  <Building2 className="w-6 h-6 text-[#2563EB]" />
                </div>
                <h3 className="text-xl font-bold mb-3 font-heading">Mining Sector M&A</h3>
                <p className="text-gray-300 text-sm mb-6 leading-relaxed">
                  Advised on the R1.8B acquisition of a platinum mining operation, including complex BEE structuring and regulatory approvals across three jurisdictions.
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-2xl font-bold text-[#10B981]">R1.8B</div>
                  <div className="text-xs text-gray-400 font-medium">Transaction Value</div>
                </div>
              </div>
            </div>

            {/* Case Study 2 */}
            <div className="case-study-card group bg-gradient-to-br from-[#10B981] to-[#059669] p-8 rounded-2xl text-white relative overflow-hidden hover:scale-105 transition-transform duration-300">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-3 font-heading">Tech Startup Capital Raise</h3>
                <p className="text-green-100 text-sm mb-6 leading-relaxed">
                  Structured Series B funding round for fintech startup, securing R450M from international VCs and strategic investors for Pan-African expansion.
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-2xl font-bold text-white">R450M</div>
                  <div className="text-xs text-green-200 font-medium">Capital Raised</div>
                </div>
              </div>
            </div>

            {/* Case Study 3 */}
            <div className="case-study-card group bg-gradient-to-br from-[#f59e0b] to-[#d97706] p-8 rounded-2xl text-white relative overflow-hidden hover:scale-105 transition-transform duration-300">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full filter blur-[40px] pointer-events-none"></div>
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-white/20 border border-white/30 flex items-center justify-center mb-6">
                  <BarChart3 className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-xl font-bold mb-3 font-heading">Manufacturing Restructuring</h3>
                <p className="text-amber-100 text-sm mb-6 leading-relaxed">
                  Led comprehensive financial restructuring of automotive components manufacturer, negotiating with 12 creditors to preserve 850 jobs and restore profitability.
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-2xl font-bold text-white">R2.2B</div>
                  <div className="text-xs text-amber-200 font-medium">Debt Restructured</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-20 text-center">
            <h3 className="text-2xl font-bold text-[#0B132B] mb-8 font-heading">Sector Expertise</h3>
            <div className="flex flex-wrap justify-center gap-3">
              {['Mining & Resources', 'Technology & Fintech', 'Manufacturing', 'Healthcare', 'Infrastructure', 'Consumer Goods', 'Financial Services', 'Agriculture'].map((sector, i) => (
                <span key={i} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-medium hover:bg-[#2563EB] hover:text-white transition-colors cursor-default">
                  {sector}
                </span>
              ))}
            </div>
